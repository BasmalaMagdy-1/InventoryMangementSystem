...
namespace InventoryMangementSystem.Controllers
{
    public class ProductsController : Controller
    {
       private  IGenericRepository<Product> _ProductRepository;
        ...
        [HttpPost]        
        public async Task<ActionResult> Create(Product item,IFormFile ImageFile)
        {
            try
            {
                ...
                if (ImageFile != null)
                {
                    string FilePath = await _uploadFile.UploadFileAsync("\\Images\\ProductsImages\\", ImageFile);
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(int id, Product item, IFormFile ImageFile)
        {
            try
            {
                if (ImageFile != null)
